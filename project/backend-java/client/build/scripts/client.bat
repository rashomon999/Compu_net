...
set CLASSPATH=%APP_HOME%\lib\client.jar;%APP_HOME%\lib\server.jar;%APP_HOME%\lib\gson-2.13.2.jar;%APP_HOME%\lib\error_prone_annotations-2.41.0.jar


@rem Execute client
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %CLIENT_OPTS%  -classpath "%CLASSPATH%" tcp.Client %*
