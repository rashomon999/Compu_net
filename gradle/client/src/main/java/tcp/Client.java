...
/**
 * Cliente principal del sistema de chat distribuido (TCP/UDP).
 *
 * Permite a un usuario conectarse al servidor mediante TCP para:
 * 
 *     Enviar mensajes de texto individuales o a grupos.
 *     Grabar y enviar notas de voz.
 *     Iniciar o finalizar llamadas de voz en tiempo real (UDP).
 *     Ver, reproducir o eliminar su historial de mensajes y audios.
 *     Gestionar grupos (crear, unirse, salir, listar).
 *
 * Este cliente utiliza dos protocolos:
 * 
 *     TCP: para el envío de mensajes, comandos, objetos y control de sesión.
 *     UDP: para la transmisión de audio en llamadas en tiempo real.
 *
 * El programa utiliza una interfaz de texto por consola y maneja los mensajes
 * mediante hilos concurrentes y colas de mensajes (BlockingQueue).
 */
...
public class Client {
     ...
     *
     * Establece conexión con el servidor, registra el usuario,
     * inicializa el cliente UDP para llamadas de voz y lanza un
     * hilo secundario para escuchar mensajes entrantes.
     *
     * Finalmente, ejecuta el menú principal donde el usuario puede
     * interactuar con todas las funcionalidades del sistema.
     */
    ...
    public static void main(String[] args) {
        ...
        try (Socket socket = new Socket(host, tcpPort)) {
            ...
            // Streams para enviar/recibir objetos
            ...
            // Inicialización del cliente UDP para llamadas
            UDPVoiceClient voiceClient = new UDPVoiceClient(username, host);
            
            // Cola concurrente de mensajes recibidos desde el servidor
    ...
    /**
     * Graba audio desde el micrófono y lo envía como {@link VoiceMessage}.
     */
    ...
    /**
     * Inicia una llamada de voz en tiempo real con otro usuario.
     */
